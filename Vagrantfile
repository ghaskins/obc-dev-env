...
Vagrant.configure('2') do |config|
  ...
  config.vm.box_version = ENV['USE_LOCAL_OBC_BASEIMAGE'] ? "0":"0.0.2" # Vagrant does not support versioning local images, the local version is always implicitly version 0
